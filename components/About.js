...
export default function About() {
  ...
  return (
    <div className="mx-auto w-screen flex flex-col items-center relative pb-10">
      ...
      <div className="flex flex-col items-center lg:flex-row lg:justify-around lg:w-11/12 lg:mb-40">
        <img
          src={`/starter-code/images/homepage/enjoyable-place-${getDeviceSize()}.jpg`}
          alt="enjoyable place image"
          className="object-contain -mt-20 shadow-2xl block w-11/12 lg:w-96 lg:left-24 "
        />
      ...
      <div className="flex flex-col items-center lg:flex-row-reverse lg:w-full lg:justify-around">
        <div className=" flex flex-col items-center relative">
          ...
          <img
            ...
            alt="enjoyable place image"
            className="object-contain shadow-2xl w-96 lg:-mb-20"
          />
        </div>
        <div className="text-center mt-10 w-11/12 mb-16 md:w-7/12 lg:w-4/12">
          <img
            src="/starter-code/images/patterns/pattern-divide.svg"
            alt="divide pattern"
            className="object-contain w-20 mt-8 mb-10 mx-auto"
          />
